...
const Technology = () => {
  ...
  return (
    ...
    <div className="bge md:h-[1190px]   md:pt-[0px]  md:mt-[-10px] xl:h-[1000px]  md:mb-0 xl:mb-0 md:overflow-hidden  xl:overflow-hidden bg-cover text-white  bg-no-repeat z-0 h-screen">
      <Navbar/>
