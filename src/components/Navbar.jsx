...
const Navbar = () => {
  ...
  return (
    <nav className="flex  w-screen md:fixed  bg-black lg:bg-transparent  overflow-x-hidden md:pl-10   justify-between pt-4 pl-4 pr-2">
     <Link to={"/"} >
      <img
        src="https://res.cloudinary.com/dhvwthnzq/image/upload/v1710170669/space-tour/Group_2_zyec8i.png"
        alt=""
        className="h-[48px] w-[48px] md:mt-6   lg:mt-[64px] lg:ml-4"

      />
      </Link>
      <div className="md:flex hidden  lg:flex lg:bg-transparent lg:backdrop-blur-lg lg:mt-[40px] lg:pr-[200px] lg:gap-10 md:bg-[rgb(255,255,255,4%)] p-9 text-white gap-5">
